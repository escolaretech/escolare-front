...
import polyplay from "../public/images/produtos/polyplay.jpg";
import coletor from "../public/images/produtos/coletor.jpg";
import estante from "../public/images/produtos/estante.jpg";
import memoria from "../public/images/produtos/memoria.jpg";
...
const Home: NextPage = () => {
  ...
  const { cart, cartOpen, handleCartOpen } = useCart();
            ...
            <div className="h-16 flex items-center overflow-hidden">
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="flex lg:ml-6">
                  <a href="#" className="p-2 text-gray-400 hover:text-gray-500">
                    ...
                    <div className="relative my-2">
                      ...
                      />
                      <SearchIcon
                        className="absolute top-3 right-3 text-gray-200  w-6 h-6"
                        aria-hidden="true"
                      />
                    </div>
                  </a>
                ...
                <div className="ml-4 flow-root lg:ml-6">
                  <button
                    onClick={() => handleCartOpen(!cartOpen)}
